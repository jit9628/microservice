...
<body>
	...
	<section>
		<div class="container">
			<div class="product_detail my-5">
				<div class="row" id="apendSliderImage">
						...
						<div class="prd_details">
							...
							<div class="prt_04 mb-4">
								...
								<div class="text-left pb-0 pt-2">
										...
										<div
											class="form-check size-option form-option form-check-inline mb-2 ischecked" id="appendsize">
	...
	<script>
		...
		function selectedSize() {
			...
			//console.log(val);
			//console.log("Selected size is ::"+details);
		}
					...
					.click(
							function() {
								...
								if (val=="M") {
									...
									$(".addcheck").addClass("form-check-input:checked form-option-label");
								
								}

								 if (val=="L") {
									document.getElementByClassNames("addcheck").style.border = "1px solid #000";
